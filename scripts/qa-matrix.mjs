export const qaMatrix = [
  ...
  ["VERIFICATION-EVIDENCE-AND-SCOPE", "Public verification evidence and async project isolation", "P0", "E2E Browser / IndexedDB", "Explicit faulty external responses", "Recheck wrong page, incomplete 200, absent quality, switch project during request", "No false verified state and no late cross-project update", "full"],
