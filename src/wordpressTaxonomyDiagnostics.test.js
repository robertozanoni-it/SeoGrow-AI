...
test("workflow separa diagnostica e sampler read-only dalla guardia Doctor/Yoast", () => {
  ...
  assert.match(workflow, /inputs\.mode == 'taxonomy-rank-math-doctor' \|\| inputs\.mode == 'taxonomy-yoast'/);
  ...
  assert.doesNotMatch(workflow, /inputs\.mode == 'taxonomy-rank-math' \|\| inputs\.mode == 'taxonomy-yoast'/);
});
