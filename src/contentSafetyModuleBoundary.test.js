...
test("Content facade preserves editorial safety behavior", () => {
...
test("editorial safety business logic belongs to Content and the legacy shim is removed", async () => {
  ...
  await assert.rejects(
    readFile(new URL("./editorialContentSafety.js", import.meta.url), "utf8"),
