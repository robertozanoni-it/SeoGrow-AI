...
export default function CorrectionsWorkspace() {
  ...
  const reverify = async (id) => {
    ...
    try {
      ...
      } else if (result?.needsAudit && updated?.frontendConfirmed === true && launchConfirmation(updated)) {
        return;
