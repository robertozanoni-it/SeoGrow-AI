...
## Esito registrato — 2026-09-07

Matrice minima read-only PASS su Yoga Buena Onda staging, eseguita dal Mac dell’utente. Report trascritto: `docs/qa/G13-STAGING-2026-09-07.json`. Account temporanei eliminati e password amministrative di prova revocate; dettagli e provenienza in `docs/COLLAUDO-STATUS-2026-09-07.md`. Nessuna write ruolo-per-ruolo o prova su produzione effettuata. Il consenso precedente riguarda questa sessione e questo staging, non autorizza automaticamente altri siti.
